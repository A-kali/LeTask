    ...
    <el-header height="90px" style="text-align: right; font-size: 30px; box-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.1)">
      ...
      <el-col :span="2">
        <el-card :body-style="{ padding: '0px' }" shadow="never">
          <img class="image" src="./element.png" height="50">
        </el-card>
      </el-col>
    </el-header>
    ...
    <el-container>
      <el-main style="box-shadow: 0 2px 4px rgba(0, 0, 0, .12), 0 0 6px rgba(0, 0, 0, .04)">
        <el-tabs value="first" type="card" stretch>
              ...
              <el-collapse>
                  ...
                  <div style="height:30px; line-height:30px;">
                    ...
                    <el-button-group style="float:right">
                      ...
                      <el-button type="primary" icon="el-icon-check" size="mini" plain
                        @click="finishTask(tasks.maintask,'maintask')">{{tasks.maintask.money}}CNY</el-button>
                ...
                <el-collapse-item title="支线任务 SideQuest" name="2">
                  <div v-for="item in tasks.sidequest" style="height:30px; line-height:30px;">
                    ...
                    <el-button-group style="float:right">
                      ...
                      <el-button type="primary" icon="el-icon-check" size="mini" plain
                        @click="finishTask(item,'sidequest')">{{item.money}}CNY</el-button>
                      <el-button type="primary" icon="el-icon-delete" size="mini" plain
                ...
                <el-collapse-item title="日常任务 Daily" name="3">
                  <div v-for="item in tasks.daily" style="height:30px; line-height:30px;">
                    ...
                    <el-button-group style="float:right">
                      ...
                      <el-button type="primary" icon="el-icon-check" size="mini" plain
                        @click="finishTask(item,'daily')">{{item.money}}CNY</el-button>
                      <el-button type="primary" icon="el-icon-delete" size="mini" plain
                  ...
                  <div v-for="item in tasks.challenge" v-if="item.belong_to==0" style="height:30px; line-height:30px;">
                    ...
                    <el-button-group style="float:right">
                      ...
                      <el-button v-if="item.isAccepted==1" type="primary" icon="el-icon-check" size="mini" plain
                        @click="finishTask(item,'challenge')">{{item.money}}CNY</el-button>
                      <el-button v-if="item.isAccepted==0" type="primary" icon="el-icon-info" size="mini" plain
                        @click="acceptChallenge(item)">接受挑战！</el-button>
                      <el-button type="primary" icon="el-icon-delete" size="mini" plain
                ...
                <el-collapse-item title="多段任务 Multistage" name="6">
                  <div v-for="item in tasks.multistage" style="height:50px; line-height:20px;">
                    ...
                    <el-button-group style="float:right">
                      <el-button type="primary" icon="el-icon-check" size="mini" plain
                        @click="finishTask(item,'multistage')">{{item.money}}CNY</el-button>
                      <el-button type="primary" icon="el-icon-delete" size="mini" plain
                 ...
                 <el-collapse-item title="附加任务 Addition" name="7">
                  <div v-for="item in tasks.addition" style="height:30px; line-height:30px;">
                    ...
                    <el-button-group style="float:right">
                      ...
                      <el-button type="primary" icon="el-icon-check" size="mini" plain
                        @click="finishAdditionTask(item)">{{item.money*count}}CNY</el-button>
                      <el-button type="primary" icon="el-icon-delete" size="mini" plain
                ...
                <el-collapse-item name="7">
                  <el-input-number v-model="count" :min="1" label="计数" style="float:right"></el-input-number></el-collapse-item>
               <el-collapse-item v-for="(item,key) in tasks.challenge" :key='key' v-if="(item.isAccepted==true)&&(item.belong_to==0)" :title="item.title" name="9" >
                  <div v-for="(item2,key) in tasks.challenge" :key='key' v-if="item2.belong_to==item.id" style="height:30px; line-height:30px;">
                    ...
                    <el-button-group style="float:right">
                      ...
                      <el-button type="primary" icon="el-icon-check" size="mini" plain
                        @click="finishTask(item2,'challenge')">{{item2.money}}CNY</el-button>
                      <el-button type="primary" icon="el-icon-delete" size="mini" plain
              ...
              <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="80px">
                ...
                <el-form-item label="所属任务" v-if="ruleForm.type=='challenge'">
                  <el-select v-model="ruleForm.belong_to" placeholder="请选择所属">
                    <el-option v-for="(item,key) in tasks.challenge" :key='item.title' :label="item.title" :value="item.id"></el-option>
                  </el-select>
                </el-form-item>
          ...
          <el-tab-pane name="third"><span slot="label"><i class="el-icon-time"></i> 成长纪录</span>
            <el-card class="borden-card">
              <el-form :inline="true" :model="formInline" ref="formInline">
                ...
                <el-form-item label="">
                  <el-radio-group v-model="formInline.type">
                    ...
                    <el-tooltip class="item" effect="dark" placement="top">
                      <div slot="content">补番：2CNY/集<br />看电影：6CNY/部<br />刷空间：1CNY/次</div>
                ...
                <el-form-item>
                  <el-button type="primary" @click="submitRecordForm(formInline)">添加</el-button>
                </el-form-item>
              </el-form>
            </el-card>
            <el-card class="borden-card">
          ...
          <el-tab-pane name="forth"><span slot="label"><i class="el-icon-share"></i> 任务树</span></el-tab-pane>
        </el-tabs>
      </el-main>
    </el-container>
  </el-container>
